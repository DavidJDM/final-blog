        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="logo_area text-center">
                    <a href="index.php" class="milana-logo">Milana</a>
                    <!-- Post Date -->
                    ...
                    <div class="collapse navbar-collapse justify-content-center" id="yummyfood-nav">
                        <ul class="navbar-nav" id="yummy-nav">
                            ...
                            <li class="nav-item active">
                                <a class="nav-link" href="life-style.php">Life Style <span class="sr-only">(current)</span></a>
                            </li>
                            <li class="nav-item">
...
<div class="breadcumb-area" style="background-image: url(img/bg-img/life-style.jpg);">
