...
<head>
    ...
    <!-- Title -->
    <title>Milana's Blog | Home</title>
...
<body>
    ...
    <section class="welcome-post-sliders owl-carousel">
        ...
        <div class="welcome-single-slide">
            <!-- Post Thumb -->
            <img src="img/hawaii-img/1.JPG" alt="">
            <!-- Overlay Text -->
        ...
        <div class="welcome-single-slide">
            <!-- Post Thumb -->
            <img src="img/hawaii-img/2.JPG" alt="">
            <!-- Overlay Text -->
            <div class="project_title">
                <div class="post-date-commnents d-flex">
                    <a href="#">May 19, 2017</a>
        ...
        <div class="welcome-single-slide">
            <!-- Post Thumb -->
            <img src="img/hawaii-img/3.JPG" alt="">
            <!-- Overlay Text -->
            <div class="project_title">
                <div class="post-date-commnents d-flex">
                    <a href="#">May 19, 2017</a>
        ...
        <div class="welcome-single-slide">
            <!-- Post Thumb -->
            <img src="img/hawaii-img/4.JPG" alt="">
            <!-- Overlay Text -->
            <div class="project_title">
                <div class="post-date-commnents d-flex">
                    <a href="#">May 19, 2017</a>
        ...
        <div class="welcome-single-slide">
            <!-- Post Thumb -->
            <img src="img/hawaii-img/5.JPG" alt="">
            <!-- Overlay Text -->
            <div class="project_title">
                <div class="post-date-commnents d-flex">
                    <a href="#">May 19, 2017</a>
        ...
        <div class="welcome-single-slide">
            <!-- Post Thumb -->
            <img src="img/hawaii-img/6.JPG" alt="">
            <!-- Overlay Text -->
            <div class="project_title">
                <div class="post-date-commnents d-flex">
                    <a href="#">May 19, 2017</a>
        ...
        <div class="welcome-single-slide">
            <!-- Post Thumb -->
            <img src="img/hawaii-img/7.JPG" alt="">
            <!-- Overlay Text -->
            <div class="project_title">
                <div class="post-date-commnents d-flex">
                    <a href="#">May 19, 2017</a>
                    ...
                    <div class="blog-sidebar mt-5 mt-lg-0">
                        ...
                        <div class="single-widget-area about-me-widget text-center">
                            ...
                            <div class="about-me-widget-thumb">
                                <img src="img/hawaii-img/1-profile.JPG" alt="">
                            </div>
                            <h4 class="font-shadow-into-light">Milana Kovalevich</h4>
